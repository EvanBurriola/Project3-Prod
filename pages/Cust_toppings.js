...
export default function Cust_toppings({inventory, menu}) {
                    ...
                    <Col xs={8} md={8}>
                        ...
                        <Row>
                            <Col className="d-flex justify-content-end">
                                <Button className="me-auto" href="/Cust_cheese_sauce" variant="primary" >Previous Page</Button>
                                <Button href="/Cust_drink_SI" variant="primary" >Next Page</Button>
                            </Col>
                        </Row>
                    </Col>
